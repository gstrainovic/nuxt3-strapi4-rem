<template>
  <section :class="`faq__area faq__style-3 p-relative z-index-1 
  ${padd ? `pt-${padd}` : ''} ${padd_2 ? `pb-${padd_2}` : 'pb-115'}`">
    <div class="container">
      <div class="row">
        <div class="col-xxl-5 col-xl-5 col-lg-6">
          <div class="faq__wrapper" data-sal="slide-up" data-sal-delay="130" data-sal-duration="1000">
            <div class="section__title-wrapper-7 mb-60">
              <span class="section__title-pre-7">Common Questions</span>
              <h3 class="section__title-7">Frequently <br> asked
            ...
            <div class="faq__tab tp-tab pr-200">
              <nav>
                <div class="nav nav-tabs flex-column" id="nav-tab" role="tablist">
                  <button class="nav-link active" id="nav-general-tab" data-bs-toggle="tab" data-bs-target="#nav-general"
                    ...
                    <span>
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M10 15.3951V12.6914" stroke="currentColor" opacity=".4" stroke-width="2"
                  ...
                  <button class="nav-link" id="nav-community-tab" data-bs-toggle="tab" data-bs-target="#nav-community"
                  ...
                  <button class="nav-link" id="nav-support-tab" data-bs-toggle="tab" data-bs-target="#nav-support"
                    type="button" role="tab" aria-controls="nav-support" aria-selected="false">
                    <span>
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                        ...
                        <path opacity=".4"
                          d="M10.8996 12.907C10.8996 13.978 10.5036 14.968 9.83765 15.7509C8.94669 16.8309 7.53374 17.5238 5.9498 17.5238L3.6009 18.9188C3.20491 19.1618 2.70093 18.8288 2.75493 18.3698L2.97992 16.5969C1.77397 15.7599 1 14.419 1 12.907C1 11.3231 1.84597 9.92816 3.14192 9.10019C3.94289 8.57821 4.90584 8.28125 5.9498 8.28125C8.68569 8.28125 10.8996 10.3511 10.8996 12.907Z"
                          stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </span>
                    Support
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              :class="`tab-pane fade ${item.active ? 'show active' : ''}`"
                ...
                <div class="accordion" :id="`${item.id}_accordion`">
                  <single-faq v-for="(faq, i) in item.faq_items" :key="i" :item="faq" />
                </div>
              </div>
            </div>
          </div>
