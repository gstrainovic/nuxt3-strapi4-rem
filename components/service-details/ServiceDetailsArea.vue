      ...
      <div class="row">
          ...
          <div class="services__widget-2 pr-50">
            <div class="services__widget-item-2 mb-30">
              <div class="services__widget-tab-2 tp-tab">
                <ul>
                  <li>
                    <nuxt-link href="/service-details" class="active">
                      <span>
        ...
        <div class="col-lg-8 order-first order-lg-last">
          <div class="services__details-wrapper">
            <h3 class="services__details-title">World best web <br>design service provider.</h3>
            ...
            <div class="services__details-text mb-45">
              <h3 class="services__details-text-title">Speed Optimized</h3>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="services__details-list mb-45">
                  <h3 class="services__details-list-title">Our Goal</h3>
                  <ul>
              ...
              <div class="col-md-6">
                <div class="services__details-text mb-45">
                  <h3 class="services__details-text-title services__details-text-title-2">The Challange</h3>
                  <p>Harry web offers a complete lineup of features from any major Maecena quis interdum, orci at euis
                    dapibus,ante pharetra tellus.</p>
                </div>
              </div>
            </div>
            <!-- faq start -->
