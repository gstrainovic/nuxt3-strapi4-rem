<template>
  <section class="services__area pt-110 pb-100 grey-bg-15">
    <div class="container">
        <div class="row">
          <div class="col-xxl-12">
              <div class="tp-section-wrapper-3 mb-50 text-center">
                <span class="tp-section-subtitle-3">List Grid</span>
                <h3 class="tp-section-title-3">List Grid Style</h3>
              </div>
          </div>
        </div>
        <div class="row">
          <div class="col-xl-6 col-lg-6">
              <div class="services__item-15 d-sm-flex align-items-start transition-3 mb-30"
              data-sal="slide-up" data-sal-delay="130" data-sal-duration="1000">
                <div class="services__icon-15 mr-45">
                    <span>
                ...
                <div class="services__content-15">
                    <h3 class="services__title-15">
                      <nuxt-link href="/service-details">Responsive Design</nuxt-link>
                    </h3>
                    <p>There are many variations of passages of <br> lorem Ipsum available.!</p>
          ...
          <div class="col-xl-6 col-lg-6">
              ...
              data-sal="slide-up" data-sal-delay="130" data-sal-duration="1000">
                ...
                <div class="services__content-15">
                    <h3 class="services__title-15">
                      <nuxt-link href="/service-details">SEO Optimized</nuxt-link>
                    </h3>
                    <p>There are many variations of passages of <br> lorem Ipsum available.!</p>
          ...
          <div class="col-xl-6 col-lg-6">
              ...
              data-sal="slide-up" data-sal-delay="160" data-sal-duration="1000">
                ...
                <div class="services__content-15">
                    <h3 class="services__title-15">
                      <nuxt-link href="/service-details">Daily Updates</nuxt-link>
                    </h3>
                    <p>There are many variations of passages of <br> lorem Ipsum available.!</p>
          ...
          <div class="col-xl-6 col-lg-6">
              ...
              data-sal="slide-up" data-sal-delay="160" data-sal-duration="1000">
                ...
                <div class="services__content-15">
                    <h3 class="services__title-15">
                      <nuxt-link href="/service-details">Fast Support</nuxt-link>
                    </h3>
                    <p>There are many variations of passages of <br> lorem Ipsum available.!</p>
